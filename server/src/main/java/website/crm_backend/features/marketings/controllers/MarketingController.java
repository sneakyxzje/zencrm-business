...
public class MarketingController {
    ...
    @GetMapping
    public ResponseEntity<Page<LeadListDTO>> getAllLeads(@RequestParam(required = false) String search, Pageable pageable) {
        return ResponseEntity.ok(marketingService.getAllLeads(search, pageable));
    }
}
