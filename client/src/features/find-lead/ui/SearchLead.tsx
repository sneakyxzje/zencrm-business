...
import { useFindLead } from "@features/find-lead/model/useFindLead";
...
export const SearchPopup = ({
  ...
  const { loading, error, result, reset, submit } = useFindLead(phoneNumber);
      ...
      {open && (
        <>
          ...
          >
            ...
            {/* Content */}
            <form onSubmit={onSubmit} className="p-8 bg-[#2a2c2e]">
              {/* Search Input */}
              <div className="mb-6">
